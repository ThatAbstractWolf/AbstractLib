package com.abstractstudios.lib.reflection;
...
public class ReflectionUtil {
    ...
    public enum PackageType {
        ...
        /**
         * Returns the version of your server, if using Bukkit.
         *
        ...
        public static String getServerVersion() {
            ...
            try {
                Class<?> clazz = Class.forName("Bukkit");
                return clazz.getMethod("getServer").invoke(clazz).getClass().getPackage().getName().substring(23);
            } catch (Exception e) {
                e.printStackTrace();
            }
